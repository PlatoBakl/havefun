...
<body class="login-page ls-closed">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Admin<b>HaveFun</b></a>
        ...
        <div class="card">
            <div class="body">
                <form action="{{ route('login') }}" method="POST" novalidate="novalidate">
                    {{ csrf_field() }}
                    <div class="msg">Вход  только для админа</div>
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="material-icons">person</i>
                        </span>
                        <div class="form-line">
                            <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="Эл. почта" required="" autofocus="" aria-required="true" aria-invalid="false">
                            @if ($errors->has('email'))
